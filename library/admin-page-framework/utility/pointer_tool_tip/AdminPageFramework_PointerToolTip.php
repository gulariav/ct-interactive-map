...
class CtInteractiveMap_AdminPageFramework_PointerToolTip extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertInternalScript() {
        echo "<script type='text/javascript' class='ct-interactive-map-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
