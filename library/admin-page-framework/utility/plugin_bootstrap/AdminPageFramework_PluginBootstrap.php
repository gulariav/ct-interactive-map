...
abstract class CtInteractiveMap_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('CtInteractiveMap_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new CtInteractiveMap_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
