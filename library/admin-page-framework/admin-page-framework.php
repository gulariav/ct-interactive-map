...
if (!class_exists('CtInteractiveMap_AdminPageFramework_Registry', false)):
    abstract class CtInteractiveMap_AdminPageFramework_Registry_Base {
    ...
    final class CtInteractiveMap_AdminPageFramework_Registry extends CtInteractiveMap_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['CtInteractiveMap_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['CtInteractiveMap_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('CtInteractiveMap_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['CtInteractiveMap_AdminPageFramework_InclusionClassFilesHeader']);
        }
    ...
    if (!class_exists('CtInteractiveMap_AdminPageFramework_Bootstrap', false)):
        final class CtInteractiveMap_AdminPageFramework_Bootstrap {
            static private $_bLoaded = false;
            public function __construct($sLibraryPath) {
                if (!$this->_isLoadable()) {
                    return;
                }
                CtInteractiveMap_AdminPageFramework_Registry::setUp($sLibraryPath);
                if (CtInteractiveMap_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                    return;
                }
                $this->_include();
            }
            ...
            private function _include() {
                include (CtInteractiveMap_AdminPageFramework_Registry::$sAutoLoaderPath);
                new CtInteractiveMap_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('CtInteractiveMap_AdminPageFramework_MinifiedVersionHeader', 'CtInteractiveMap_AdminPageFramework_BeautifiedVersionHeader',),), CtInteractiveMap_AdminPageFramework_Registry::$aClassFiles);
                self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
                if (self::$_bXDebug) {
                    new CtInteractiveMap_AdminPageFramework_Utility;
                    new CtInteractiveMap_AdminPageFramework_WPUtility;
                }
            }
            static private $_bXDebug;
        }
        new CtInteractiveMap_AdminPageFramework_Bootstrap(__FILE__);
    endif;
