...
abstract class CtInteractiveMap_AdminPageFramework_TermMeta_Router extends CtInteractiveMap_AdminPageFramework_TaxonomyField_Controller {
    }
    abstract class CtInteractiveMap_AdminPageFramework_TermMeta_Model extends CtInteractiveMap_AdminPageFramework_TermMeta_Router {
        ...
        private function _getSavedTermMetas($iTermID, array $aFieldsets) {
            $_oMetaData = new CtInteractiveMap_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
    ...
    abstract class CtInteractiveMap_AdminPageFramework_TermMeta_View extends CtInteractiveMap_AdminPageFramework_TermMeta_Model {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_TermMeta_Controller extends CtInteractiveMap_AdminPageFramework_TermMeta_View {
    }
    abstract class CtInteractiveMap_AdminPageFramework_TermMeta extends CtInteractiveMap_AdminPageFramework_TermMeta_Controller {
        protected $_sStructureType = 'term_meta';
        public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'ct-interactive-map') {
