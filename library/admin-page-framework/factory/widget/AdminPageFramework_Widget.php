...
abstract class CtInteractiveMap_AdminPageFramework_Widget_Router extends CtInteractiveMap_AdminPageFramework_Factory {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Widget_Model extends CtInteractiveMap_AdminPageFramework_Widget_Router {
        ...
        public function _replyToRegisterWidget() {
            ...
            $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new CtInteractiveMap_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
            $this->oProp->oWidget = $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName];
        }
    }
    abstract class CtInteractiveMap_AdminPageFramework_Widget_View extends CtInteractiveMap_AdminPageFramework_Widget_Model {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Widget_Controller extends CtInteractiveMap_AdminPageFramework_Widget_View {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Widget extends CtInteractiveMap_AdminPageFramework_Widget_Controller {
        protected $_sStructureType = 'widget';
        public function __construct() {
            $_sThisClassName = get_class($this);
            $_bAssumedAsWPWidget = 0 === func_num_args();
            $_aDefaults = array('', array(), 'edit_theme_options', 'ct-interactive-map');
