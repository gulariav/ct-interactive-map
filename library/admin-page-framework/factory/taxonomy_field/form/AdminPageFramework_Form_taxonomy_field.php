...
class CtInteractiveMap_AdminPageFramework_Form_taxonomy_field extends CtInteractiveMap_AdminPageFramework_Form {
    ...
    public function get() {
        ...
        $_oFieldsets = new CtInteractiveMap_AdminPageFramework_Form_View___FieldsetRows($this->getElementAsArray($this->aFieldsets, '_default'), null, $this->aSavedData, $this->getFieldErrors(), $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
