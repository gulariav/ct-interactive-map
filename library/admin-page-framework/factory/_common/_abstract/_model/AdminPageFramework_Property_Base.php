...
abstract class CtInteractiveMap_AdminPageFramework_Property_Base extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'ct-interactive-map' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aCtInteractiveMap_AdminPageFramework'])) {
            $GLOBALS['aCtInteractiveMap_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => CtInteractiveMap_AdminPageFramework_Registry::NAME, 'sURI' => CtInteractiveMap_AdminPageFramework_Registry::URI, 'sScriptName' => CtInteractiveMap_AdminPageFramework_Registry::NAME, 'sLibraryName' => CtInteractiveMap_AdminPageFramework_Registry::NAME, 'sLibraryURI' => CtInteractiveMap_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => CtInteractiveMap_AdminPageFramework_Registry::getVersion(), 'sDescription' => CtInteractiveMap_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => CtInteractiveMap_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => CtInteractiveMap_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => CtInteractiveMap_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => CtInteractiveMap_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new CtInteractiveMap_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
