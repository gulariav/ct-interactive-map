...
abstract class CtInteractiveMap_AdminPageFramework_Resource_Base extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'ct-interactive-map-style';
    protected $_sClassSelector_Script = 'ct-interactive-map-script';
    ...
    private function _getStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), CtInteractiveMap_AdminPageFramework_CSS::getDefaultCSS());
    ...
    private function _getIEStyleTag($oCaller, $sIDPrefix) {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), CtInteractiveMap_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), CtInteractiveMap_AdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle() {
        ...
        $this->_printCommonStyles('ct-interactive-map-style-common', get_class());
    ...
    public function _replyToAddScript() {
        ...
        $this->_printCommonScripts('ct-interactive-map-script-common', get_class());
