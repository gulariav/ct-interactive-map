...
class CtInteractiveMap_AdminPageFramework_Form_View___Section_Base extends CtInteractiveMap_AdminPageFramework_Form_Base {
    ...
    public function getFieldsetOutput($aFieldset) {
        ...
        $_oFieldset = new CtInteractiveMap_AdminPageFramework_Form_View___Fieldset($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
        $_sFieldOutput = $_oFieldset->get();
        return $_sFieldOutput;
    }
    }
    class CtInteractiveMap_AdminPageFramework_Form_View___SectionTitle extends CtInteractiveMap_AdminPageFramework_Form_View___Section_Base {
        ...
        private function _getToolTip($_aSectionset) {
            ...
            $_oToolTip = new CtInteractiveMap_AdminPageFramework_Form_View___ToolTip($_aSectionset['tip'], $_sSectionTitleTagID);
        ...
        private function _getDebugInfo($aSectionset) {
            ...
            $_oToolTip = new CtInteractiveMap_AdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('section_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => CtInteractiveMap_AdminPageFramework_Debug::getDetails($aSectionset) . '<span class="ct-interactive-map-info">' . $this->getFrameworkNameVersion() . '  (' . $this->oMsg->get('debug_info_will_be_disabled') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aSectionset['_section_path'] . '_debug');
            return $_oToolTip->get();
        }
        private function _getCollapseButton($aCollapsible) {
            ...
            return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='ct-interactive-map-collapsible-button ct-interactive-map-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='ct-interactive-map-collapsible-button ct-interactive-map-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
        }
        ...
        private function _getFieldsetsInSectionTitleArea(array $aFieldsets, $iSectionIndex, $aFieldTypeDefinitions) {
            ...
            foreach ($aFieldsets as $_aFieldset) {
                ...
                $_oFieldsetOutputFormatter = new CtInteractiveMap_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $iSectionIndex, $aFieldTypeDefinitions);
    ...
    class CtInteractiveMap_AdminPageFramework_Form_View___CollapsibleSectionTitle extends CtInteractiveMap_AdminPageFramework_Form_View___SectionTitle {
        ...
        private function _getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer = 'sections', $iSectionIndex = null) {
            ...
            return $this->_getCollapsibleSectionsEnablerScript() . "<div " . $this->getAttributes(array('id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('ct-interactive-map-section-title', $this->getAOrB('box' === $aCollapsible['type'], 'accordion-section-title', ''), 'ct-interactive-map-collapsible-title', $this->getAOrB('sections' === $aCollapsible['container'], 'ct-interactive-map-collapsible-sections-title', 'ct-interactive-map-collapsible-section-title'), $this->getAOrB($aCollapsible['is_collapsed'], 'collapsed', ''), 'ct-interactive-map-collapsible-type-' . $aCollapsible['type']),) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
        }
        ...
        protected function _getCollapsibleSectionsEnablerScript() {
            ...
            self::$_bLoaded = true;
            new CtInteractiveMap_AdminPageFramework_Form_View___Script_CollapsibleSection($this->oMsg);
        }
    }
