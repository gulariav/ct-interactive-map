...
class CtInteractiveMap_AdminPageFramework_Form_View___FieldsetTableRow extends CtInteractiveMap_AdminPageFramework_Form_View___Section_Base {
    ...
    protected function _getFieldByContainer(array $aFieldset, array $aOpenCloseTags) {
        ...
        $_oFieldTitle = new CtInteractiveMap_AdminPageFramework_Form_View___FieldTitle($aFieldset, '', $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_aOutput = array();
    ...
    class CtInteractiveMap_AdminPageFramework_Form_View___FieldsetRow extends CtInteractiveMap_AdminPageFramework_Form_View___FieldsetTableRow {
        public $aFieldset = array();
        public $aSavedData = array();
        public $aFieldErrors = array();
        public $aFieldTypeDefinitions = array();
        ...
        public function get() {
            ...
            $_oFieldrowAttribute = new CtInteractiveMap_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
