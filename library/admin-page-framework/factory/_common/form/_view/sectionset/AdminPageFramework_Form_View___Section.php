...
class CtInteractiveMap_AdminPageFramework_Form_View___Section extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        $_oTableCaption = new CtInteractiveMap_AdminPageFramework_Form_View___SectionCaption($this->aSectionset, $_iSectionIndex, $this->aFieldsetsPerSection, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_oSectionTableAttributes = new CtInteractiveMap_AdminPageFramework_Form_View___Attribute_SectionTable($this->aSectionset);
        $_oSectionTableBodyAttributes = new CtInteractiveMap_AdminPageFramework_Form_View___Attribute_SectionTableBody($this->aSectionset);
        $_aOutput = array();
        ...
        $_oSectionTableContainerAttributes = new CtInteractiveMap_AdminPageFramework_Form_View___Attribute_SectionTableContainer($this->aSectionset);
    ...
    private function _getSectionContent($_iSectionIndex) {
        ...
        $_oFieldsets = new CtInteractiveMap_AdminPageFramework_Form_View___FieldsetRows($this->aFieldsetsPerSection, $_iSectionIndex, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        return $_oFieldsets->get();
    }
    private function _getCustomSectionContent() {
        if (is_scalar($this->aSectionset['content'])) {
            return "<tr class='ct-interactive-map-custom-content'>" . "<td>" . $this->aSectionset['content'] . "</td>" . "</tr>";
        }
        ...
        $_oFormTables = new CtInteractiveMap_AdminPageFramework_Form_View___Sectionsets($_aArguments, $_aStructure, $this->aSavedData, $this->aFieldErrors, $this->aCallbacks, $this->oMsg);
        return "<tr class='ct-interactive-map-nested-sectionsets'>" . "<td>" . $_oFormTables->get() . "</td>" . "</tr>";
    }
