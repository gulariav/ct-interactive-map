...
class CtInteractiveMap_AdminPageFramework_Form_View___ToolTip extends CtInteractiveMap_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return "<a " . $this->_getElementAttributes('container', 'ct-interactive-map-form-tooltip') . ">" . $this->_getTipLinkIcon() . "<span " . $this->_getElementAttributes('content', 'ct-interactive-map-form-tooltip-content') . ">" . $this->_getTipTitle() . $this->_getDescriptions() . "</span>" . "</a>";
    }
    ...
    private function _getTipTitle() {
        if (isset($this->aArguments['title'])) {
            return "<span " . $this->_getElementAttributes('title', 'ct-interactive-map-form-tooltip-title') . ">" . $this->aArguments['title'] . "</span>";
        }
        return '';
    }
    private function _getDescriptions() {
        if (isset($this->aArguments['content'])) {
            return "<span " . $this->_getElementAttributes('description', 'ct-interactive-map-form-tooltip-description') . ">" . implode("</span><span " . $this->_getElementAttributes('description', 'ct-interactive-map-form-tooltip-description') . ">", $this->getAsArray($this->aArguments['content'])) . "</span>";
        }
        return '';
    }
