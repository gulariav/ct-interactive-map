...
class CtInteractiveMap_AdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends CtInteractiveMap_AdminPageFramework_Form_View___Attribute_Base {
    ...
    protected function _getAttributes() {
        return array('id' => $this->sSectionsID, 'class' => $this->getClassAttribute('ct-interactive-map-sections', $this->getAOrB(!$this->sSectionTabSlug || '_default' === $this->sSectionTabSlug, null, 'ct-interactive-map-section-tabs-contents'), $this->getAOrB(empty($this->aCollapsible), null, 'ct-interactive-map-collapsible-sections-content' . ' ' . 'ct-interactive-map-collapsible-content' . ' ' . 'accordion-section-content'), $this->getAOrB(empty($this->aSectionset['sortable']), null, 'sortable-section')), 'data-seciton_id' => $this->aSectionset['section_id'], 'data-section_address' => $this->aSectionset['section_id'], 'data-section_address_model' => $this->aSectionset['section_id'] . '|' . '___i___',) + $this->_getDynamicElementArguments($this->aSectionset);
    }
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new CtInteractiveMap_AdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset['_caller_object']->aCallbacks['hfSectionName']);
