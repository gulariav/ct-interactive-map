...
abstract class CtInteractiveMap_AdminPageFramework_Form_View___Attribute_Base extends CtInteractiveMap_AdminPageFramework_Form_Utility {
    public $sContext = '';
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Form_View___Attribute_FieldContainer_Base extends CtInteractiveMap_AdminPageFramework_Form_View___Attribute_Base {
        protected function _getFormattedAttributes() {
    ...
    class CtInteractiveMap_AdminPageFramework_Form_View___Attribute_Field extends CtInteractiveMap_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
        public $sContext = 'field';
        protected function _getAttributes() {
            $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " ct-interactive-map-field-{$this->aArguments['type']}", '');
            ...
            return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "ct-interactive-map-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' ct-interactive-map-subfield', ''));
        }
    }
