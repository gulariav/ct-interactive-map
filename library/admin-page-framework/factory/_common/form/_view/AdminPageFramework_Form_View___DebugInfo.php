...
class CtInteractiveMap_AdminPageFramework_Form_View___DebugInfo extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='ct-interactive-map-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
