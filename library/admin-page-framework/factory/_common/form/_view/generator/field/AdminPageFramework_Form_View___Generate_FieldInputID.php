...
class CtInteractiveMap_AdminPageFramework_Form_View___Generate_FieldTagID extends CtInteractiveMap_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class CtInteractiveMap_AdminPageFramework_Form_View___Generate_FieldInputID extends CtInteractiveMap_AdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
