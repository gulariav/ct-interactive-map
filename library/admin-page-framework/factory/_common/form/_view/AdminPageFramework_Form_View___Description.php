...
class CtInteractiveMap_AdminPageFramework_Form_View___Description extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'ct-interactive-map-form-element-description';
