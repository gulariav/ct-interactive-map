...
class CtInteractiveMap_AdminPageFramework_Form_View___Script_Widget extends CtInteractiveMap_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.ct-interactive-map-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'ct-interactive-map_saved_widget', 
                    _oWidget 
                );
