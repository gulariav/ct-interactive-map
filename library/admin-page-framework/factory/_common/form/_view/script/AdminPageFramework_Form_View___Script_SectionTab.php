...
class CtInteractiveMap_AdminPageFramework_Form_View___Script_SectionTab extends CtInteractiveMap_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.ct-interactive-map-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='ct-interactive-map-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
