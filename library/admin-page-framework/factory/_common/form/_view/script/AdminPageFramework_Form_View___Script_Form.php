...
class CtInteractiveMap_AdminPageFramework_Form_View___Script_Form extends CtInteractiveMap_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeCtInteractiveMap_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.ct-interactive-map-form-loading' ).remove();
        jQuery( '.ct-interactive-map-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.ct-interactive-map-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeCtInteractiveMap_AdminPageFrameworkLoadingOutputs();
