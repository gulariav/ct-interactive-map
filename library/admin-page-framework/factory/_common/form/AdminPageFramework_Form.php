...
abstract class CtInteractiveMap_AdminPageFramework_Form_Utility extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    static public function getFieldsetReformattedBySubFieldIndex($aFieldset, $iSubFieldIndex, $bHasSubFields, $aParentFieldset) {
        ...
        $_oFieldsetFormatter = new CtInteractiveMap_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $aFieldset['_structure_type'], $aFieldset['capability'], ( integer )$iSubFieldIndex + 1, $aFieldset['_subsection_index'], $aFieldset['_is_section_repeatable'], $aFieldset['_caller_object']);
        $aFieldset = $_oFieldsetFormatter->get();
        $_oFieldsetOutputFormatter = new CtInteractiveMap_AdminPageFramework_Form_Model___Format_FieldsetOutput($aFieldset, $aFieldset['_section_index'], $_oCallerForm->aFieldTypeDefinitions);
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Form_Base extends CtInteractiveMap_AdminPageFramework_Form_Utility {
    ...
    class CtInteractiveMap_AdminPageFramework_Form_Model extends CtInteractiveMap_AdminPageFramework_Form_Base {
        ...
        public function getSortedInputs(array $aFormInputs) {
            ...
            $_oInputSorter = new CtInteractiveMap_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
        ...
        public function dropRepeatableElements(array $aSubject) {
            $_oFilterRepeatableElements = new CtInteractiveMap_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
        ...
        public function _replyToRegisterFormItems() {
            ...
            $_oFieldResources = new CtInteractiveMap_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
        ...
        private function _setSiteWideFieldTypeDefinitions() {
            ...
            $_oBuiltInFieldTypeDefinitions = new CtInteractiveMap_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
        ...
        public function getDefaultFormValues() {
            $_oDefaultValues = new CtInteractiveMap_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
            return $_oDefaultValues->get();
        }
        protected function _formatElementDefinitions(array $aSavedData) {
            $_oSectionsetsFormatter = new CtInteractiveMap_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
            $this->aSectionsets = $_oSectionsetsFormatter->get();
            $_oFieldsetsFormatter = new CtInteractiveMap_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
    ...
    class CtInteractiveMap_AdminPageFramework_Form_View extends CtInteractiveMap_AdminPageFramework_Form_Model {
        public function __construct() {
            parent::__construct();
            new CtInteractiveMap_AdminPageFramework_Form_View__Resource($this);
        }
        public function get() {
        ...
        private function _getNoScriptMessage() {
            ...
            return "<noscript>" . "<div class='error'>" . "<p class='ct-interactive-map-form-warning'>" . $this->oMsg->get('please_enable_javascript') . "</p>" . "</div>" . "</noscript>";
        }
        public function printSubmitNotices() {
            $this->oSubmitNotice->render();
        }
    }
    class CtInteractiveMap_AdminPageFramework_Form_Controller extends CtInteractiveMap_AdminPageFramework_Form_View {
    ...
    class CtInteractiveMap_AdminPageFramework_Form extends CtInteractiveMap_AdminPageFramework_Form_Controller {
        ...
        public $oFieldError;
        public $oLastInputs;
        public $aSubClasses = array('submit_notice' => 'CtInteractiveMap_AdminPageFramework_Form___SubmitNotice', 'field_error' => 'CtInteractiveMap_AdminPageFramework_Form___FieldError', 'last_input' => 'CtInteractiveMap_AdminPageFramework_Form_Model___LastInput', 'message' => 'CtInteractiveMap_AdminPageFramework_Message',);
        public function __construct() {
