...
class CtInteractiveMap_AdminPageFramework_Form_Model___Format_RepeatableSection extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : CtInteractiveMap_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class CtInteractiveMap_AdminPageFramework_Form_Model___Format_RepeatableField extends CtInteractiveMap_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
