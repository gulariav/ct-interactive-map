...
abstract class CtInteractiveMap_AdminPageFramework_Form_Model___Format_FormField_Base extends CtInteractiveMap_AdminPageFramework_Form_Utility {
    }
    class CtInteractiveMap_AdminPageFramework_Form_Model___Format_EachField extends CtInteractiveMap_AdminPageFramework_Form_Model___Format_FormField_Base {
        ...
        public function get() {
            ...
            $_oInputTagIDGenerator = new CtInteractiveMap_AdminPageFramework_Form_View___Generate_FieldInputID($_aField, $this->isIndex, $this->aCallbacks['hfID']);
            $_aField['input_id'] = $_oInputTagIDGenerator->get();
            $_oFieldInputNameGenerator = new CtInteractiveMap_AdminPageFramework_Form_View___Generate_FieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputName']);
            $_aField['_input_name'] = $_oFieldInputNameGenerator->get();
            $_oFieldFlatInputName = new CtInteractiveMap_AdminPageFramework_Form_View___Generate_FlatFieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputNameFlat']);
            ...
            $_aField['_field_object'] = new CtInteractiveMap_AdminPageFramework_ArrayHandler($_aField);
            return $_aField;
        }
    }
