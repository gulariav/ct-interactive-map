...
class CtInteractiveMap_AdminPageFramework_Form_Model___FormatFieldsets extends CtInteractiveMap_AdminPageFramework_Form_Base {
    ...
    private function _getDynamicElementsAddedToFieldsets() {
        $_oDynamicElements = new CtInteractiveMap_AdminPageFramework_Form_Model___FormatDynamicElements($this->aSectionsets, $this->aFieldsets, $this->aSavedData);
    ...
    private function _getFieldsetFormatted($aFieldset, $aSectionsets, $sCapability, $iCountOfElements, $iSubSectionIndex, $bIsSectionRepeatable, $oCallerObject) {
        ...
        $_oFieldsetFormatter = new CtInteractiveMap_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $this->sStructureType, $sCapability, $iCountOfElements, $iSubSectionIndex, $bIsSectionRepeatable, $oCallerObject);
