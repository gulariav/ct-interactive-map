...
class CtInteractiveMap_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions {
    ...
    public function get() {
        ...
        foreach (self::$_aDefaultFieldTypeSlugs as $_sFieldTypeSlug) {
            $_sFieldTypeClassName = "CtInteractiveMap_AdminPageFramework_FieldType_{$_sFieldTypeSlug}";
