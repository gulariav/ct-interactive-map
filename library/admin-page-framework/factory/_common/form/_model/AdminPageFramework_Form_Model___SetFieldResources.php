...
class CtInteractiveMap_AdminPageFramework_Form_Model___SetFieldResources extends CtInteractiveMap_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new CtInteractiveMap_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('CtInteractiveMap_AdminPageFramework_Form_View___CSS_Form', 'CtInteractiveMap_AdminPageFramework_Form_View___CSS_Field', 'CtInteractiveMap_AdminPageFramework_Form_View___CSS_Section', 'CtInteractiveMap_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'CtInteractiveMap_AdminPageFramework_Form_View___CSS_FieldError', 'CtInteractiveMap_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('CtInteractiveMap_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new CtInteractiveMap_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new CtInteractiveMap_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
