...
class CtInteractiveMap_AdminPageFramework_FieldType_import extends CtInteractiveMap_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".ct-interactive-map-field-import input {margin-right: 0.5em;}.ct-interactive-map-field-import label,.form-table td fieldset.ct-interactive-map-fieldset .ct-interactive-map-field-import label { display: inline; }";
    }
