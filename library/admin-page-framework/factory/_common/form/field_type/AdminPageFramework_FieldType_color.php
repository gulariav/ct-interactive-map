...
abstract class CtInteractiveMap_AdminPageFramework_FieldType_Base extends CtInteractiveMap_AdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : CtInteractiveMap_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new CtInteractiveMap_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new CtInteractiveMap_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_FieldType extends CtInteractiveMap_AdminPageFramework_FieldType_Base {
        public function _replyToFieldLoader() {
            $this->setUp();
        }
        public function _replyToGetScripts() {
    ...
    class CtInteractiveMap_AdminPageFramework_FieldType_color extends CtInteractiveMap_AdminPageFramework_FieldType {
        ...
        protected function getStyles() {
            return ".repeatable .colorpicker {display: inline;}.ct-interactive-map-field-color .wp-picker-container {vertical-align: middle;}.ct-interactive-map-field-color .ui-widget-content {border: none;background: none;color: transparent;}.ct-interactive-map-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.ct-interactive-map-field-color .ct-interactive-map-repeatable-field-buttons {margin-top: 0;}.ct-interactive-map-field-color .wp-color-result {margin: 3px;}";
        }
        protected function getScripts() {
            $_aJSArray = json_encode($this->aFieldTypeSlugs);
            $_sDoubleQuote = '\"';
            return <<<JAVASCRIPTS
registerCtInteractiveMap_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    var _aDefaults = {
        ...
        change: function( event, ui ){
            jQuery( this ).trigger( 
                'ct-interactive-map_field_type_color_changed',
        ...
        clear: function( event, ui ) {
            jQuery( this ).trigger(
                'ct-interactive-map_field_type_color_cleared',
    ...
    jQuery().registerCtInteractiveMap_AdminPageFrameworkCallbacks( {     
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( 'input.input_color' ).each( function( iIterationIndex ) {
                ...
                registerCtInteractiveMap_AdminPageFrameworkColorPickerField( _oNewColorInput );                
...
jQuery( document ).ready( function(){
    registerCtInteractiveMap_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
