...
class CtInteractiveMap_AdminPageFramework_FieldType_section_title extends CtInteractiveMap_AdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".ct-interactive-map-section-tab .ct-interactive-map-field-section_title {padding: 0.5em;} .ct-interactive-map-section-tab .ct-interactive-map-field-section_title .ct-interactive-map-input-label-string { vertical-align: middle; margin-left: 0.2em;}.ct-interactive-map-section-tab .ct-interactive-map-fields {display: inline-block;} .ct-interactive-map-field.ct-interactive-map-field-section_title {float: none;} .ct-interactive-map-field.ct-interactive-map-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
