...
class CtInteractiveMap_AdminPageFramework_FieldType_radio extends CtInteractiveMap_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".ct-interactive-map-field input[type='radio'] {margin-right: 0.5em;} .ct-interactive-map-field-radio .ct-interactive-map-input-label-container {padding-right: 1em;} .ct-interactive-map-field-radio .ct-interactive-map-input-container {display: inline;} .ct-interactive-map-field-radio .ct-interactive-map-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.ct-interactive-map-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
