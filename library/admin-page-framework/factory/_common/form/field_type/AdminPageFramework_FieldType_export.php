...
class CtInteractiveMap_AdminPageFramework_FieldType_submit extends CtInteractiveMap_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".ct-interactive-map-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'ct-interactive-map-input-label-container' . ' ct-interactive-map-input-button-container' . ' ct-interactive-map-input-container',);
    }
    ...
    class CtInteractiveMap_AdminPageFramework_FieldType_export extends CtInteractiveMap_AdminPageFramework_FieldType_submit {
