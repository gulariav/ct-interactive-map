...
class CtInteractiveMap_AdminPageFramework_FieldType_checkbox extends CtInteractiveMap_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '{$_sClassSelectorSelectAll}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllCtInteractiveMap_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '{$_sClassSelectorSelectNone}' ).each( function(){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllCtInteractiveMap_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
});
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.ct-interactive-map-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.ct-interactive-map-checkbox-label {margin-top: 0.1em;}.ct-interactive-map-field input[type='checkbox' ] {margin-right: 0.5em;} .ct-interactive-map-field-checkbox .ct-interactive-map-input-label-container {padding-right: 1em;}.ct-interactive-map-field-checkbox .ct-interactive-map-input-label-string{display: inline; }";
    }
    ...
    class CtInteractiveMap_AdminPageFramework_FieldType_posttype extends CtInteractiveMap_AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".ct-interactive-map-field input[type='checkbox'] {margin-right: 0.5em;} .ct-interactive-map-field-posttype .ct-interactive-map-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
