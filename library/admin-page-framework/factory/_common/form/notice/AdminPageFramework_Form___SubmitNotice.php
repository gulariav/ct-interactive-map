...
class CtInteractiveMap_AdminPageFramework_Form___SubmitNotice extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new CtInteractiveMap_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new CtInteractiveMap_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
    }
