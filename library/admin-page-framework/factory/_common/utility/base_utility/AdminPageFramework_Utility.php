...
abstract class CtInteractiveMap_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        CtInteractiveMap_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return CtInteractiveMap_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        CtInteractiveMap_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return CtInteractiveMap_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        CtInteractiveMap_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        CtInteractiveMap_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        CtInteractiveMap_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'CtInteractiveMap_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_VariableType extends CtInteractiveMap_AdminPageFramework_Utility_Deprecated {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_String extends CtInteractiveMap_AdminPageFramework_Utility_VariableType {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_Array extends CtInteractiveMap_AdminPageFramework_Utility_String {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_ArrayGetter extends CtInteractiveMap_AdminPageFramework_Utility_Array {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_ArraySetter extends CtInteractiveMap_AdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_Path extends CtInteractiveMap_AdminPageFramework_Utility_ArraySetter {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_URL extends CtInteractiveMap_AdminPageFramework_Utility_Path {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_File extends CtInteractiveMap_AdminPageFramework_Utility_URL {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_SystemInformation extends CtInteractiveMap_AdminPageFramework_Utility_File {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_Utility_HTMLAttribute extends CtInteractiveMap_AdminPageFramework_Utility_SystemInformation {
    ...
    class CtInteractiveMap_AdminPageFramework_Utility extends CtInteractiveMap_AdminPageFramework_Utility_HTMLAttribute {
