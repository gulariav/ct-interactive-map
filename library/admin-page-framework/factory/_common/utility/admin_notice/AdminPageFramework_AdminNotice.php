...
class CtInteractiveMap_AdminPageFramework_AdminNotice extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'ct-interactive-map-settings-notice-message', 'ct-interactive-map-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new CtInteractiveMap_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
