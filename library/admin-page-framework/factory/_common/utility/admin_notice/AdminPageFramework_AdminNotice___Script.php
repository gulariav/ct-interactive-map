...
class CtInteractiveMap_AdminPageFramework_AdminNotice___Script extends CtInteractiveMap_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.ct-interactive-map-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='ct-interactive-map-admin-notice-animation-container'></div>" );
