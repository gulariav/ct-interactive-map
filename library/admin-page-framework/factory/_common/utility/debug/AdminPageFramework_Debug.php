...
class CtInteractiveMap_AdminPageFramework_Debug_Base extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    ...
    class CtInteractiveMap_AdminPageFramework_Debug_Log extends CtInteractiveMap_AdminPageFramework_Debug_Base {
    ...
    class CtInteractiveMap_AdminPageFramework_Debug extends CtInteractiveMap_AdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('CtInteractiveMap_AdminPageFramework_Debug::' . __FUNCTION__, 'CtInteractiveMap_AdminPageFramework_Debug::dump()');
            CtInteractiveMap_AdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('CtInteractiveMap_AdminPageFramework_Debug::' . __FUNCTION__, 'CtInteractiveMap_AdminPageFramework_Debug::get()');
            return CtInteractiveMap_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('CtInteractiveMap_AdminPageFramework_Debug::' . __FUNCTION__, 'CtInteractiveMap_AdminPageFramework_Debug::log()');
            CtInteractiveMap_AdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('CtInteractiveMap_AdminPageFramework_Debug::' . __FUNCTION__);
