...
class CtInteractiveMap_AdminPageFramework_FrameworkUtility extends CtInteractiveMap_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = CtInteractiveMap_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return CtInteractiveMap_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
    }
    class CtInteractiveMap_AdminPageFramework_ArrayHandler extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
        public $aData = array();
