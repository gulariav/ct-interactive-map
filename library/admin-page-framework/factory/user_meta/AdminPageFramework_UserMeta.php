...
abstract class CtInteractiveMap_AdminPageFramework_UserMeta_Router extends CtInteractiveMap_AdminPageFramework_Factory {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_UserMeta_Model extends CtInteractiveMap_AdminPageFramework_UserMeta_Router {
        public function _replyToGetSavedFormData() {
            $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
            $_oMetaData = new CtInteractiveMap_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
    ...
    abstract class CtInteractiveMap_AdminPageFramework_UserMeta_View extends CtInteractiveMap_AdminPageFramework_UserMeta_Model {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_UserMeta_Controller extends CtInteractiveMap_AdminPageFramework_UserMeta_View {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_UserMeta extends CtInteractiveMap_AdminPageFramework_UserMeta_Controller {
        protected $_sStructureType = 'user_meta';
        public function __construct($sCapability = 'read', $sTextDomain = 'ct-interactive-map') {
