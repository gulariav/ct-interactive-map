...
class CtInteractiveMap_AdminPageFramework_View__Resource extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new CtInteractiveMap_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new CtInteractiveMap_AdminPageFramework_Format_PageResource_Script($asPageScript);
