...
class CtInteractiveMap_AdminPageFramework_View__PageRenderer__PageHeadingTabs extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    private function _getPageHeadingtabNavigationBar(array $aPages, $sTag, $sCurrentPageSlug) {
        $_oTabBar = new CtInteractiveMap_AdminPageFramework_TabNavigationBar($aPages, $sCurrentPageSlug, $sTag, array(), array('format' => array($this, '_replyToFormatNavigationTabItem_PageHeadingTab'),));
        $_sTabBar = $_oTabBar->get();
        return $_sTabBar ? "<div class='ct-interactive-map-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }
