...
class CtInteractiveMap_AdminPageFramework_View__PageRenderer extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    public function render() {
        ...
        <div class="<?php echo esc_attr($this->oFactory->oProp->sWrapperClassAttribute); ?>">
            ...
            <div class="ct-interactive-map-container">
                <?php
        ...
        $this->_printPageMetaBoxes(); ?>
            ...
            </div><!-- .ct-interactive-map-container -->
    ...
    private function _getContentTop() {
        $_oScreenIcon = new CtInteractiveMap_AdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new CtInteractiveMap_AdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new CtInteractiveMap_AdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printMainPageContent($sPageSlug, $sTabSlug) {
        ...
        echo "<div class='ct-interactive-map-content'>";
        ...
        echo "</div><!-- .ct-interactive-map-content -->";
    }
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new CtInteractiveMap_AdminPageFramework_View__PageMataBoxRenderer();
    ...
    private function _printFormOpeningTag($fEnableForm = true) {
        ...
        echo "<form " . $this->getAttributes(array('method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'ct-interactive-map-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)),)) . " >" . PHP_EOL;
