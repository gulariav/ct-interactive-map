...
class CtInteractiveMap_AdminPageFramework_Property_admin_page extends CtInteractiveMap_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'ct-interactive-map') {
        ...
        $GLOBALS['aCtInteractiveMap_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aCtInteractiveMap_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aCtInteractiveMap_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
