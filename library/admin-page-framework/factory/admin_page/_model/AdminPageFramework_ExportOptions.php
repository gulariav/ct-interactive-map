...
abstract class CtInteractiveMap_AdminPageFramework_CustomSubmitFields extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
    ...
    class CtInteractiveMap_AdminPageFramework_ExportOptions extends CtInteractiveMap_AdminPageFramework_CustomSubmitFields {
        public $sClassName;
        public $sFileName;
        public $sFormatType;
        public $bIsDataSet;
            ...
            switch (strtolower($sFormatType)) {
                case 'text':
                    if (in_array(gettype($vData), array('array', 'object'))) {
                        echo CtInteractiveMap_AdminPageFramework_Debug::get($vData, null, false);
                    }
                    echo $vData;
                    return;
                case 'json':
