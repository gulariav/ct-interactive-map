...
abstract class CtInteractiveMap_AdminPageFramework_Model__FormSubmission_Base extends CtInteractiveMap_AdminPageFramework_Form_Utility {
    ...
    class CtInteractiveMap_AdminPageFramework_Model__FormSubmission extends CtInteractiveMap_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new CtInteractiveMap_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
