...
class CtInteractiveMap_AdminPageFramework_Model_Menu__RegisterMenu extends CtInteractiveMap_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToRegisterSubMenuItems() {
        ...
        foreach ($_aPages as $_aSubMenuItem) {
            $_oFormatter = new CtInteractiveMap_AdminPageFramework_Format_SubMenuItem($_aSubMenuItem, $this->oFactory, ++$_iParsedIndex);
