...
class CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator_Base extends CtInteractiveMap_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator extends CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__Link', 'CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__Import', 'CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__Export', 'CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
