...
class CtInteractiveMap_AdminPageFramework_Model__FormSubmission__Validator__Filter extends CtInteractiveMap_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
