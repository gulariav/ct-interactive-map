...
abstract class CtInteractiveMap_AdminPageFramework_PageMetaBox_Router extends CtInteractiveMap_AdminPageFramework_MetaBox_View {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_PageMetaBox_Model extends CtInteractiveMap_AdminPageFramework_PageMetaBox_Router {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_PageMetaBox_View extends CtInteractiveMap_AdminPageFramework_PageMetaBox_Model {
    }
    abstract class CtInteractiveMap_AdminPageFramework_PageMetaBox_Controller extends CtInteractiveMap_AdminPageFramework_PageMetaBox_View {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_PageMetaBox extends CtInteractiveMap_AdminPageFramework_PageMetaBox_Controller {
        protected $_sStructureType = 'page_meta_box';
        public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'ct-interactive-map') {
