...
class CtInteractiveMap_AdminPageFramework_Property_page_meta_box extends CtInteractiveMap_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'ct-interactive-map', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aCtInteractiveMap_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aCtInteractiveMap_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aCtInteractiveMap_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aCtInteractiveMap_AdminPageFramework', 'aPageClasses'));
