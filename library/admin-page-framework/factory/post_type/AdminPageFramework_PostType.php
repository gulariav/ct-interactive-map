...
abstract class CtInteractiveMap_AdminPageFramework_PostType_Router extends CtInteractiveMap_AdminPageFramework_Factory {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_PostType_Model extends CtInteractiveMap_AdminPageFramework_PostType_Router {
        public function __construct($oProp) {
            parent::__construct($oProp);
            ...
            if ($this->oProp->bIsAdmin) {
                ...
                if ($this->oProp->sCallerPath) {
                    new CtInteractiveMap_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
                }
            }
        }
        ...
        public function _replyToRegisterPostType() {
            ...
            new CtInteractiveMap_AdminPageFramework_PostType_Model__SubMenuOrder($this);
        }
    ...
    abstract class CtInteractiveMap_AdminPageFramework_PostType_View extends CtInteractiveMap_AdminPageFramework_PostType_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            if ($this->oProp->bIsAdmin) {
        ...
        public function _replyToPrintStyle() {
            ...
            if (!empty($this->oProp->sStyle)) {
                echo "<style type='text/css' id='ct-interactive-map-style-post-type'>" . $this->oProp->sStyle . "</style>";
            }
        }
    ...
    abstract class CtInteractiveMap_AdminPageFramework_PostType_Controller extends CtInteractiveMap_AdminPageFramework_PostType_View {
    ...
    abstract class CtInteractiveMap_AdminPageFramework_PostType extends CtInteractiveMap_AdminPageFramework_PostType_Controller {
        protected $_sStructureType = 'post_type';
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'ct-interactive-map') {
            if (empty($sPostType)) {
                return;
            }
            $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'CtInteractiveMap_AdminPageFramework_Property_' . $this->_sStructureType;
            ...
            $this->oProp->sPostType = CtInteractiveMap_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
            $this->oProp->aPostTypeArgs = $aArguments;
        ...
        private function _getCallerScriptPath($sCallerPath) {
            ...
            $_sPageNow = CtInteractiveMap_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
            if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
                return CtInteractiveMap_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
            }
            return null;
        }
    }
