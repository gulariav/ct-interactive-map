...
class CtInteractiveMap_AdminPageFramework_Property_post_meta_box extends CtInteractiveMap_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'ct-interactive-map', $sStructureType = 'post_meta_box') {
